...
function Donate() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!phone.trim() || !/^\d{10}$/.test(phone)) {
      setError('Por favor, informe um número de telefone válido de 10 dígitos');
      return;
    }
    if (!date) {
    ...
    if (!donationType) {
      setError('Por favor, selecione um tipo de doação');
      return;
    }
    if (donationType === 'money' && !amount) {
      setError('Por favor, selecione um valor para a doação');
      return;
    }
    ...
    try {
      ...
      setSuccess('Obrigado! Sua doação foi enviada com sucesso.');
      setShowPopup(true);
      setName('');
      setPhone('');
      setDate('');
      ...
      setError(error.message || 'Erro no servidor, por favor tente novamente mais tarde');
    } finally {
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <p id="nameHelp" className="text-xs text-gray-500 mt-1">
                Seu nome nos ajuda a reconhecer sua contribuição.
              </p>
            </div>
            ...
            <div>
              ...
              <input
                ...
                placeholder="Informe seu número de telefone de 10 dígitos"
                className="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-50 text-gray-700"
                required
                pattern="\d{10}"
              ...
              <p id="phoneHelp" className="text-xs text-gray-500 mt-1">
                Usaremos este número para contatá-lo se necessário.
              </p>
            </div>
            ...
            <div>
              ...
              <input
                ...
                placeholder="Informe sua cidade ou localização"
                className="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-50 text-gray-700"
                required
                aria-describedby="locationHelp"
              />
              <p id="locationHelp" className="text-xs text-gray-500 mt-1">
                De onde você está doando?
              </p>
            </div>
            ...
            <div>
              ...
              >
                ...
                <option value="education">Material Educacional</option>
                <option value="medical">Material Médico</option>
              </select>
              <p id="donationTypeHelp" className="text-xs text-gray-500 mt-1">
                Escolha o tipo de doação para apoiar aqueles em necessidade.
              </p>
            </div>
            ...
            {donationType === 'money' && (
              <div>
                ...
                <p id="amountHelp" className="text-xs text-gray-500 mt-1">
                  Selecione um valor para contribuir.
                </p>
              </div>
            )}
      ...
      {showPopup && (
        <div className="fixed inset-0 flex items-center justify-center z-50">
          <div className="bg-[#004B8D] text-white p-6 rounded-lg shadow-2xl text-center animate-fade-in">
            <h3 className="text-xl font-bold">Obrigado Por Doar Para Nós</h3>
          </div>
        </div>
      )}
    </div>
