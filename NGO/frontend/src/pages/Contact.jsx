...
function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccess('Obrigado! Sua mensagem foi enviada com sucesso.');
      setName('');
      setEmail('');
      setMessage('');
    } catch (error) {
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <p id="nameHelp" className="text-xs text-gray-500 mt-1">
              Seu nome nos ajuda a lhe endereçar corretamente.
            </p>
          </div>
          ...
          <div>
            ...
            <p id="emailHelp" className="text-xs text-gray-500 mt-1">
              Usaremos este email para responder sua consulta.
            </p>
          </div>
          ...
          <div>
            ...
            <p id="messageHelp" className="text-xs text-gray-500 mt-1">
              Contate-nos e vamos ajudar você.
            </p>
          </div>
